                        ...
                        <form class="space-y-6" action="/register" method="POST">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    ...
                                    <input id="name" name="name" type="text"  autocomplete="name" required class="input input-bordered w-full max-w-xs"
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input id="email" name="email" type="email" autocomplete="email" required class="input input-bordered w-full max-w-xs"
                            ...
                            <div>
                                ...
                                if (isset($_GET['message'])){
                                    echo "<div class='text-red-600''> {$_GET['message']} </div>";
                                }
                                ?>
                            </div>
